...
namespace Helper.Editor {
    /// <summary>
    /// Extension for the UI Elements
    /// </summary>
    public static class UIElementExt {
        public static GUIStyle BoldLabelStyle(int labelSize = 12) => new (GUI.skin.label) {fontSize = labelSize, fontStyle = FontStyle.Bold};

        #region HelpBox
        /// <summary>
        /// Draw a HelpBox with a specific message and specific type
        /// </summary>
        /// <param name="text"></param>
        /// <param name="type"></param>
        public static void DrawHelpBoxError(string text, MessageType type) {
            GUI.backgroundColor = type switch {
                MessageType.Error => Color.red,
                MessageType.Info => Color.white,
                MessageType.Warning => Color.yellow,
                MessageType.None => Color.white,
        ...
        public static void DrawColoredLabel(string label, Color col, params GUILayoutOption[] options) => DrawColoredLabel(label, col, GUI.skin.label);

        /// <summary>
        /// Draw a label with a custom color and a custom style
        /// </summary>
        /// <param name="label"></param>
        /// <param name="col"></param>
        /// <param name="style"></param>
        public static void DrawColoredLabel(string label, Color col, GUIStyle style, params GUILayoutOption[] options) {
            GUI.color = col;
    ...
    /// <summary>
    /// Extension for the Visual Elements
    /// </summary>
    public static class VisualElementExt {
        /// <summary>
        /// Create a Label and add the specific options to it
        /// </summary>
        /// <param name="action"></param>
        /// <param name="flexGrow"></param>
        /// <returns></returns>
        public static Label CreateLabel(string labelTitle, string text, params VisualElementOption[] options) {
            Label label = new Label {
                name = labelTitle,
                text = text
            };
            label.CheckVisualElementOptions(options);
            return label;
        }
